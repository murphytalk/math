...
## Task 20
list_sum_zip = [i[0]+i[1] for i in zip([10, 25, 40],[1, 15, 20])]
...
base = 10
digits = set(range(10))
representation_dict = { x1*base*base+x2*base+x3:[x1,x2,x3] for x1 in digits for x2 in digits for x3 in digits}
